...
local function fun_return_value(args)
  return sn(nil,
    args[1][1] == "void" and { t("    "), i(1) } or
    { t("    return "), i(1), t(";"), }
  )
end
...
return {
  ...
  s({ trig = "class", dscr = "'class' snippet" }, {
    ...
    rep(1), t("("), rep(1), t({ " const& other) noexcept = default;", "\t\t" }),
  ...
  s({ trig = "fun", dscr = "function snippet" }, {
    i(1, "int"), t(" "), i(2, "function"), t("("), i(3, ""), t(")"),
    t({ "", "{", "" }),
    d(4, fun_return_value, { 1 }),
    t({ "", "}" }),
  }),
}
